...
import { Home, Image, MessageSquareHeart, Calendar, Settings } from 'lucide-react'
...
export default function MainLayout() {
  ...
  const navItems = [
    ...
    { path: '/app/timeline', icon: Image, label: 'Timeline' },
    { path: '/app/planning', icon: Calendar, label: 'Projets' },
    { path: '/app/coach', icon: MessageSquareHeart, label: 'Coach IA' },
