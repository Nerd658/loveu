...
## 2024-07-26 - Preventing Duplicate Animations on Interactive Elements
**Learning:** When interactive elements trigger delayed visual transitions or animations (e.g., via `setTimeout` or `classList` toggles), rapid double-clicks can queue duplicate execution paths, causing unexpected behavior or overlapping transitions.
