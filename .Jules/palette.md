...
## 2024-05-18 - Managing Canvas Interactive Buttons
**Learning:** When using `<canvas>` elements as interactive buttons, they lack native disabled states and default interactive feedback.
